function initJeuTriDechets(containerId, options = {}) {
    const defaultItems = [
        { id: 'cable', img: '../../public/image/durabilite/cables.png', context: 'Câble grillé défectueux', correct: 'trash' },
        { id: 'imprimante', img: '../../public/image/durabilite/imprimante.png', context: 'Imprimante non reconnue', correct: 'recycle' },
        { id: 'ordi1', img: '../../public/image/durability/ordinateur.png', context: 'Ordinateur grillé HS', correct: 'trash' },
        { id: 'ordi2', img: '../../public/image/durability/ordinateur.png', context: 'Ordinateur batterie HS', correct: 'recycle' },
        { id: 'telephone', img: '../../public/image/durability/telephone.png', context: 'Téléphone écran cassé', correct: 'recycle' }
    ];
    ...
    container.innerHTML = `
        ...
        <div class="bins">
            <div class="bin trash" id="trash_${containerId}">
                <img src="../../public/flappyHearth/durabilite/trash.jpg" class="bin-icon" alt="Poubelle Générale">
                <label>Poubelle Générale</label>
            </div>
            <div class="bin recycle" id="recycle_${containerId}">
                <img src="../../public/image/durabilite/recyclage.jpg" class="bin-icon" alt="Recyclage">
